...
def idade_cs(df, ax=None):
    ...
    ax.set_title('Idade das Vítimas de Crimes Sexuais')
...
def ano_cs(df, ax=None):
    ...
    ax.set_title('Quantidade de Crimes Sexuais por Ano')
    ax.set_xlabel('Ano')
    ax.set_ylabel('Quantidade')
...
def mes_cs(df, ax=None):
    ...
    ax.set_title('Quantidade de Crimes Sexuais por Mês')
    ax.set_xlabel('Mês')
    ax.set_ylabel('Quantidade')
...
def dia_semana_cs(df, ax=None):
    ...
    ax.set_title('Quantidade de Crimes Sexuais por Dia da Semana')
